...
const Color kLightPrimaryColor = Color(0xFF0066FF);
const Color kLightAccentColor = Color(0xFF0066FF);
const Color kLightTextColor = Color(0xff1F1A3D);
const Color kLightPlaceholderColor = Colors.white;
const Color kLightPlaceholderTextColor = Color(0xFFE8EAF0); //Color(0xffF5F6FA);
const Color kLightBackgroundColor = Colors.white;
const Color kLightErrorColor = Color(0xFFFF7971);
final Color enabledBorderClr = Color(0xFF0066FF);
...
const kBorderSide = BorderSide(color: Color(0xFF0066FF), width: 1);
...
final kPageItemSpacing = SizedBox(height: 50.h);
...
final kElevatedButtonPadding = EdgeInsets.symmetric(
  vertical: 18.h,
);
